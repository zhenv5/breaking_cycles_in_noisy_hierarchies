...
if __name__ == "__main__":
	...
	parser.add_argument("-s","--score_name",default = "pagerank",help = "nodes score function: trueskill, socialagony, pagerank...")
	...
	if players_score_name != "ensembling":
		...
		report_performance(args.gt_edges_file,e1, players_score_name + " Hiearchy_Greedy (H_G)")
		report_performance(args.gt_edges_file,e2, players_score_name + " Hiearchy_Forward(H_F)")
		report_performance(args.gt_edges_file,e3, players_score_name + " Hiearchy_Backward (H_B)")
		report_performance(args.gt_edges_file,e4, players_score_name + " Hiearchy_Voting (H_Voting)")
	else:
		players_score_dict  = computing_hierarchy(graph_file,"socialagony")
		e1,e2,e3,_ = remove_cycle_edges_by_hierarchy(graph_file,players_score_dict,"socialagony")		
		players_score_dict  = computing_hierarchy(graph_file,"trueskill")
		e5,e6,e7,_ = remove_cycle_edges_by_hierarchy(graph_file,players_score_dict,"trueskill")
		e8 = remove_cycle_edges_by_voting(graph_file,[set(e1),set(e2),set(e3),set(e5),set(e6),set(e7)])
		report_performance(args.gt_edges_file,e8,"ensembling trueskill and socialagony (H_Voting)")